...
public class VideoList extends Activity {
    ...
    public void bindVideos(ArrayList dataList) {
        setContentView(R.layout.video_list_layout);

        final VideoListAdapter adp = new VideoListAdapter(this, dataList);

        final GridView gvVideos = (GridView)findViewById(R.id.gvVideos);
        gvVideos.setAdapter(adp);
        gvVideos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                Object selectedItem = gvVideos.getItemAtPosition(position);
                Video VideoItem = (Video)selectedItem;

                Intent intentSendVideoReference = new Intent(VideoList.this, VideoDetail.class);
                intentSendVideoReference.putExtra("VideoItem", VideoItem);
                startActivity(intentSendVideoReference);
            }
        });
    ...
    class getList extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            String serviceParams = "GetVideos";
            ...
            if(responseText!= "")
            {
                try{
                    ...
                    Type typeList = new TypeToken<List<Video>>(){}.getType();
